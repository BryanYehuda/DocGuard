...
public class DownloadImg extends AppCompatActivity {
    ...
    String DOWNLOAD_URL = Endpoints.GET_PICS_URL;
                ...
                response -> {
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            String image = link.getString("image");
    ...
    class DownloadFileFromURL extends AsyncTask < String, String, String > {
        ...
        protected String doInBackground(String...f_url) {
            ...
            try {
                ...
                OutputStream output = new FileOutputStream(Environment.getExternalStorageDirectory().toString() + "/2021.png");
